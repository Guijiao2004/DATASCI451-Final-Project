...
actual_medals <- data.frame(
  ...
  Gold = c(40, 40, 20, 18, 16),
  Silver = c(44, 27, 12, 19, 26),
  Bronze = c(42, 24, 13, 16, 22)
)

cat("USA:\n")
1 - mean(usa_pred$gold_pred <= actual_medals$Gold[1] - 5 | usa_pred$gold_pred >= actual_medals$Gold[1] + 5) 
1 - mean(usa_pred$silver_pred <= actual_medals$Silver[1] - 5 | usa_pred$silver_pred >= actual_medals$Silver[1] + 5)
1 - mean(usa_pred$bronze_pred <= actual_medals$Bronze[1] - 5 | usa_pred$bronze_pred >= actual_medals$Bronze[1] + 5)

cat("CHN:\n")
1 - mean(chn_pred$gold_pred <= actual_medals$Gold[2] - 5 | chn_pred$gold_pred >= actual_medals$Gold[2] + 5)
1 - mean(chn_pred$silver_pred <= actual_medals$Silver[2] - 5 | chn_pred$silver_pred >= actual_medals$Silver[2] + 5)
1 - mean(chn_pred$bronze_pred <= actual_medals$Bronze[2] - 5 | chn_pred$bronze_pred >= actual_medals$Bronze[2] + 5)

cat("JPN:\n")
1 - mean(jpn_pred$gold_pred <= actual_medals$Gold[3] - 5 | jpn_pred$gold_pred >= actual_medals$Gold[3] + 5)
1 - mean(jpn_pred$silver_pred <= actual_medals$Silver[3] - 5 | jpn_pred$silver_pred >= actual_medals$Silver[3] + 5)
1 - mean(jpn_pred$bronze_pred <= actual_medals$Bronze[3] - 5 | jpn_pred$bronze_pred >= actual_medals$Bronze[3] + 5)

cat("AUS:\n")
1 - mean(aus_pred$gold_pred <= actual_medals$Gold[4] - 5 | aus_pred$gold_pred >= actual_medals$Gold[4] + 5)
1 - mean(aus_pred$silver_pred <= actual_medals$Silver[4] - 5 | aus_pred$silver_pred >= actual_medals$Silver[4] + 5)
1 - mean(aus_pred$bronze_pred <= actual_medals$Bronze[4] - 5 | aus_pred$bronze_pred >= actual_medals$Bronze[4] + 5)

cat("FRA:\n")
1 - mean(fra_pred$gold_pred <= actual_medals$Gold[5] - 5 | fra_pred$gold_pred >= actual_medals$Gold[5] + 5)
1 - mean(fra_pred$silver_pred <= actual_medals$Silver[5] - 5 | fra_pred$silver_pred >= actual_medals$Silver[5] + 5)
1 - mean(fra_pred$bronze_pred <= actual_medals$Bronze[5] - 5 | fra_pred$bronze_pred >= actual_medals$Bronze[5] + 5)
